...
select `gpt-5.6-terra` and `gpt-5.6-luna` respectively. The selected model remains fixed for
...
priority rates. Terra and Luna use their documented model-specific rates rather
